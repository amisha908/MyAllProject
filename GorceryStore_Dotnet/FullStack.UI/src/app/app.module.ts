...
@NgModule({
  declarations: [
    ...
    LoginComponent, AdminviewComponent, UserviewComponent, AddProductComponent, EditProductComponent, ProductViewComponent, ProductUserViewComponent, UsernavbarComponent, AdminNavbarComponent, HomeNavbarComponent, UserOrdersComponent, UserCartComponent, AnimatedAlertComponent, AdminViewRecentOrdersComponent
  ],
  imports: [
    MatSliderModule,
    BrowserModule,
